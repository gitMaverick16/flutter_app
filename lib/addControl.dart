...
class AddControl extends StatefulWidget {
  AddControl({Key? key, required this.db}) : super(key: key);
  Database db;
  @override
  _AddState createState() => _AddState();
}

class _AddState extends State<AddControl> {
      ...
      bottomNavigationBar: Container(
        ...
        child: BottomAppBar(
          ...
          child: RaisedButton(
              color: Colors.black,
              onPressed: () {
                widget.db.createControl(pesoController.text, temperaturaController.text, presionController.text, saturacionController.text);
                Navigator.pop(context, true);
              },
              child: Text(
                "Guardar",
